...
function select_refgeneset(obj) {
	...
	if( obj.id == "btn_file_up" ){
		form.action="home/pathway_validate_file_upload";
	}
	else{
		form.action="home/pathway_fc_form";
	}
...
<nav class="navbar navbar-default" style="background-color:#0db5ba;">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href="<?php echo site_url('download');?>" style="color:black">Download and Documentation</a></li>
...
<div class="container">
	...
	<form action="home/pathway_validate_file_upload" name="submit" method="post" enctype="multipart/form-data" id="gwas_form">
    ...
    <div class="twelve columns">
      ...
      <div class="row">
      <a data-step="4" data-intro="The developer provides an example containing 75 genes analysed for drought stress condition and root plant tissue." href="javascript:ex_show2();"><b>Example</b></a> 
    </div>
    </div>
