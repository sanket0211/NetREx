		...
		<div class="container topmargin bottommargin">
			...
			<div class="row">
				<div class="col-md-6">
					...
					<?php echo form_open('home/contactusform',array('class' => 'nobottommargin','name' => 'template-contactform')); ?>
				...
				<div class="col-md-6">
					...
					<p>Feel free to contact us whenever you are in doubt. We, the Cd-CoNet team will always be there to help you out as much as possible. </p>
					...
					<ul class="list-unstyled">
						...
						<li><i class="fa fa-phone"></i> <strong>Phone:</strong> (+91)9581105549</li>

						<li><i class="fa fa-envelope"></i> <strong>Email:</strong> <a href="mailto:mail@example.com">ssanket369@gmail.com</a></li>
