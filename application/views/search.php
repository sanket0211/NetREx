...
function select_refgeneset(obj) {
	...
	if( obj.id == "btn_file_up" ){
		form.action="home/validate_file_upload";
	}
	else{
...
<nav class="navbar navbar-default" style="background-color:#0db5ba;">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active dropdown"><a href="javascript:void(0)" style="color:black" >Search</a>
      <div class="dropdown-content">
      <a style="color:black"  href="<?php echo site_url('search');?>">Network Search</a>     
      <a style="color:black"  target="_blank" href="<?php echo site_url('pathway_form');?>">Search Pathway Information</a>
      </div>
      </li>
      ...
      <li style="float:right"><a style="color:black"  href="javascript:void(0);" onclick="javascript:introJs().start();">Page Tour</a></li>
    </ul>
  </div>
</nav>
...
<div class="container">
	...
	<form action="home/validate_file_upload" name="submit" method="post" enctype="multipart/form-data" id="gwas_form">
				...
				<div class="row">
					...
					<div id="box_man_in" hidden="true">
						<label for="disease_gene_set_text">Gene set
							<!-- <img src="<?php echo base_url().'assets/images/question_mark.svg';?>" style="width:1em;vertical-align:middle" title="Comman (',') separated genes (RAPDB ids), Maximum 300 genes allowed."/> -->
						</label>
    ...
    <div class="twelve columns">
     <div data-step="2" data-intro="The user has to specify a particular stress condition. The program shall process the input gene list for the selected stress condition. The options available are Drought, Cold, ABA, JA, Osmotic, Flood."  class="six columns">
        <div class="row">
        <label for="build_ver">Stress Condition
        ...
        <select class="u-full-width" name="stress" id="stress" required>
          <?php 
      ...
      <div data-step="3" data-intro="The user has to specify a plant tissue. The program shall process the input gene list for the selected plant tissue. As of now the options available are Root and Shoot." class="six columns">
        <div class="row">
        <label for="build_ver">Tissues
    ...
    <div class="row">
		<div class="twelve columns"><p></p>
			<label>E-mail (Optional)</label>
			<input class="u-full-width" type="email" name="email_input" placeholder="If you want to receive job status information and query results via email, please submit your email address" id="exampleEmailInput">
		</div>
	</div>
	</div>
    <br>   
